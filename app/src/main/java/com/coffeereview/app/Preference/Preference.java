package com.coffeereview.app.Preference;
...
/**
 * Created by zhan on 03/10/2017.
 */

public class Preference {
    private static final String FILE_NAME = "ReadingApp.pref";
    ...
    public void putSharedPreference(Context context, String key, ArrayList<MainModel> value){
    ...
    public ArrayList<MainModel> getSharedPreference(Context context, String key ){

        ArrayList<MainModel> mSelectedList = new ArrayList<MainModel>();
        SharedPreferences mPref = context.getSharedPreferences(FILE_NAME, Activity.MODE_PRIVATE);
        Gson gson = new Gson();
        String json = mPref.getString(key, "");
        if (json.isEmpty()){
            mSelectedList = new ArrayList<MainModel>();
        }else {
            Type type =  new TypeToken<ArrayList<MainModel>>(){}.getType();
